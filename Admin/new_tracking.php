...
// Attempt insert query execution
    ...
    VALUES ('$jname','$jadd','$jcountry','$jemail','$jnumber','$sname','$sadd','$scountry','$semail','$snumber', '$prod', '$mode', '$ship_date', '$ddate', '$currentl', '$pickupl', '$status','$deliverys','$cat','$weight','$items','$descrip','AP-$me')";
