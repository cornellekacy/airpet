...
$mail->Password = "cornellekacy456";
    ...
    $mail->setFrom($email, 'Air Pets Transport And Logistics');
    ...
    if ($mail->addReplyTo($_POST['email'], $_POST['name'])) {
        $mail->Subject = 'Air Pets Transport Logistics';
...
EOT;
        ...
        if (!$mail->send()) {
            ...
            $msg = '<script>alert("Tracking Number Successfully Mailed To Jk")</script>';
        }
    } else {
